                    ...
                    <div className="bg-stone-900/80 backdrop-blur-sm border border-stone-800/60 rounded-2xl p-8 shadow-2xl shadow-black/60">
                        ...
                        <div className="text-center mb-8">
                            <div className="relative w-28 h-28 mx-auto mb-5">
                                ...
                                <div className="relative w-28 h-28 rounded-full overflow-hidden bg-gradient-to-br from-orange-400/20 to-orange-600/20 p-1 shadow-2xl shadow-orange-500/30">
                                    <Image
                        ...
                        <form onSubmit={handleLogin} className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full py-3 mt-1 rounded-xl bg-orange-600 hover:bg-orange-500 disabled:bg-stone-700 disabled:text-stone-500 text-white font-semibold flex items-center justify-center gap-2 transition-all shadow-lg shadow-orange-500/20 disabled:shadow-none"
                            >
                                {loading ? <Loader2 size={15} className="animate-spin" /> : <LogIn size={15} />}
                                {loading ? 'Entrando...' : 'Entrar no Zeninho'}
                            </button>
                        </form>
