...
export default function SistemaEs() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              <Image
                ...
                alt="Esquema técnico del panel de concreto - Parte 1"
                width={600}
                height={450}
              ...
              <Image
                ...
                alt="Esquema técnico del panel de concreto - Parte 2"
                width={600}
                height={450}
                className="rounded-lg shadow-lg border"
              />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-center">
              <Image
                ...
                alt="Detalles técnicos de las nervaduras y conexiones"
                width={630}
                height={504}
                className="rounded-lg shadow-lg border"
              />
             ...
             <div className="text-center">
              <Image
                ...
                alt="Detalle técnico de la conexión entre losa y paneles"
                width={500}
                height={400}
                className="rounded-lg shadow-lg border"
              />
            ...
            <div className="text-center">
              <div className="relative h-96 w-full mb-4 overflow-hidden rounded-lg shadow-lg">
                <Image
                  ...
                  alt="Producción de paneles en fábrica"
                  width={600}
                  height={600}
            ...
            <div className="text-center">
              <div className="relative h-96 w-full mb-4 overflow-hidden rounded-lg shadow-lg">
                <Image
                  ...
                  alt="Panel premoldeado siendo izado en rascacielos"
                  width={600}
                  height={600}
                  className="w-full h-full object-cover"
                />
