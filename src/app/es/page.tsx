        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto mb-12">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <Image src="/images/imagenscomdescricao/familia-em-frente-a-casa-nova-com-detalhe-laranja.png" alt="Familia frente al prototipo en São Simão" width={500} height={300} className="w-full h-64 object-cover" />
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-bold text-orange-600">60 días</div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <Image src="/images/imagenscomdescricao/fileira-de-predios-residenciais-novos-de-dois-andares.png" alt="Complejo habitacional T+3 en Rio Claro" width={500} height={300} className="w-full h-64 object-cover" />
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <Image src="/images/imagenscomdescricao/exterior-de-casa-terrea-quase-acabada-com-telhado-ceramico.png" alt="Casa en Várzea Paulista" width={400} height={240} className="w-full h-48 object-cover" />
              <div className="p-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="grid grid-cols-2 gap-1 h-48">
                <Image src="/images/imagenscomdescricao/duque1.jpg" alt="Edificio en Duque de Caxias - Vista 1" width={200} height={240} className="w-full h-full object-cover" />
                <Image src="/images/imagenscomdescricao/duque2.jpg" alt="Edificio en Duque de Caxias - Vista 2" width={200} height={240} className="w-full h-full object-cover" />
              </div>
              <div className="p-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <ImageModal
                ...
                alt="Patente de Estados Unidos - USPTO"
                width={250}
                height={350}
                className="rounded-lg shadow-lg border"
              />
