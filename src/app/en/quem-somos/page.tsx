          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Image
                ...
                alt="Historical construction process of TECHSUS"
                width={600}
                height={450}
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-lg font-semibold text-stone-900 mb-2">SDG 9</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-lg font-semibold text-stone-900 mb-2">SDG 11</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-lg font-semibold text-stone-900 mb-2">SDG 12</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-lg font-semibold text-stone-900 mb-2">SDG 13</h3>
              ...
              <div className="space-y-4">
                <div className="bg-white p-3 rounded-lg border text-center">
                  <Image
                    ...
                    alt="Brazil Patent Document - INPI"
                    width={180}
                    height={220}
                    className="rounded-lg mb-2 mx-auto object-cover border cursor-pointer hover:opacity-80 transition-opacity"
                    onClick={() => openImageModal("/images/imagenscomdescricao/documento-patente-brasil-inpi.png", "Brazil Patent Document - INPI")}
                  />
                ...
                <div className="bg-white p-3 rounded-lg border text-center">
                  <Image
                    ...
                    alt="United States Patent Document - USPTO"
                    width={180}
                    height={220}
                    className="rounded-lg mb-2 mx-auto object-cover border cursor-pointer hover:opacity-80 transition-opacity"
                    onClick={() => openImageModal("/images/imagenscomdescricao/documento-patente-estados-unidos.png", "United States Patent Document - USPTO")}
                  />
                ...
                <div className="bg-white p-3 rounded-lg border text-center">
                  <Image
                    ...
                    alt="China Patent Document"
                    width={180}
                    height={220}
                    className="rounded-lg mb-2 mx-auto object-cover border cursor-pointer hover:opacity-80 transition-opacity"
                    onClick={() => openImageModal("/images/imagenscomdescricao/Certificado de Patente - CHINA nº 2017800928093.jpg", "China Patent Document")}
                  />
              ...
              <div className="space-y-4">
                <div className="text-center bg-white p-3 rounded-lg border">
                  <Image
                    ...
                    alt="IPT Report #107 938-205 - System Performance"
                    width={160}
                    height={200}
                    className="rounded-lg mb-2 object-cover border cursor-pointer hover:opacity-80 transition-opacity mx-auto"
                    onClick={() => openImageModal("/images/imagenscomdescricao/relatorio-tecnico-ipt-avaliacao-de-desempenho-do-sistema.png", "IPT Report #107 938-205 - System Performance")}
                  />
                ...
                <div className="text-center bg-white p-3 rounded-lg border">
                  <Image
                    ...
                    alt="IPT Reports #107 880-205 & #107 881-205 - Thermal Comfort"
                    width={160}
                    height={200}
                    className="rounded-lg mb-2 object-cover border cursor-pointer hover:opacity-80 transition-opacity mx-auto"
                    onClick={() => openImageModal("/images/imagenscomdescricao/relatorio-tecnico-ipt-avaliacao-termica-apartamentos.png", "IPT Reports #107 880-205 & #107 881-205 - Thermal Comfort")}
                  />
              ...
              <div className="space-y-4">
                <div className="text-center bg-white p-3 rounded-lg border">
                  <Image
                    ...
                    alt="DATEC Certificate - Technical Assessment Document"
                    width={200}
                    height={140}
                    className="rounded-lg mb-2 object-contain border cursor-pointer hover:opacity-80 transition-opacity mx-auto"
                    onClick={() => openImageModal("/images/imagenscomdescricao/documento-de-avaliacao-tecnica-ipt-datec.png", "DATEC Certificate - Technical Assessment Document")}
                  />
                ...
                <div className="bg-white p-3 rounded-lg border text-center">
                  <Image
                    ...
                    alt="CDHU Logo - Housing and Urban Development Company of São Paulo State"
                    width={160}
                    height={80}
                    className="object-contain w-full h-16 mb-2 mx-auto"
                  />
                ...
                <div className="bg-white p-3 rounded-lg border text-center">
                  <Image
                    ...
                    alt="SINAT Logo - National System of Technical Approvals"
                    width={160}
                    height={80}
                    className="object-contain w-full h-16 mb-2 mx-auto"
                  />
