        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto mb-12">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <Image src="/images/imagenscomdescricao/familia-em-frente-a-casa-nova-com-detalhe-laranja.png" alt="Family in front of prototype in São Simão" width={500} height={300} className="w-full h-64 object-cover" />
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-bold text-orange-600">60 days</div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <Image src="/images/imagenscomdescricao/fileira-de-predios-residenciais-novos-de-dois-andares.png" alt="T+3 housing complex in Rio Claro" width={500} height={300} className="w-full h-64 object-cover" />
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-sm text-stone-600 bg-stone-50 p-3 rounded">
                  <strong>Result:</strong> {dict.case_studies.building_result}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <Image src="/images/imagenscomdescricao/exterior-de-casa-terrea-quase-acabada-com-telhado-ceramico.png" alt="House in Várzea Paulista" width={400} height={240} className="w-full h-48 object-cover" />
              <div className="p-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="grid grid-cols-2 gap-1 h-48">
                <Image src="/images/imagenscomdescricao/duque1.jpg" alt="Building in Duque de Caxias - View 1" width={200} height={240} className="w-full h-full object-cover" />
                <Image src="/images/imagenscomdescricao/duque2.jpg" alt="Building in Duque de Caxias - View 2" width={200} height={240} className="w-full h-full object-cover" />
              </div>
              <div className="p-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <ImageModal
                ...
                alt="United States Patent - USPTO"
                width={250}
                height={350}
                className="rounded-lg shadow-lg border"
              />
